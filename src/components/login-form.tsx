...
import { loginSchema } from '@/client/client'
		...
		<div className={cn('flex flex-col gap-6', className)} {...props}>
			<Form
				...
				onSubmit={async (data) => {
					...
					try {
						await login(data.identifier, data.plainPassword)
						router.push('/')
					} catch (err) {
						toast.error(
							`Couldn't log in, email / username or password is wrong. ${err}`
						)
						form.setError('identifier', {
							message: 'Wrong email or username.',
						})
						form.setError('plainPassword', {
			...
			>
				<div className="flex flex-col gap-6">
					<div className="flex flex-col items-center gap-2">
						...
						<h1 className="text-xl font-bold">Welcome back to Nicolas Panco</h1>
